...
/* Create a GetGlueOAuth object with consumer/user tokens. */
$connection = new GetGlueOAuth(CONSUMER_KEY, CONSUMER_SECRET, $access_token['oauth_token'], $access_token['oauth_token_secret']);
...
if (empty($active) || empty($_GET['confirmed']) || $_GET['confirmed'] !== 'TRUE') {
  echo '<h1>Warning! This page will make many requests to GetGlue.</h1>';
